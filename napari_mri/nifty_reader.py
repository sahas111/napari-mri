"""
This is a simple napari plugin for 3D-viewing of nifty files (.nii.gz) - a common MRI file format.
"""
...
def MRI_reader(path):
    ...
    # save the sagittal MRI file and view other planes (coronal and axial) by the roll-dimension button
    data = img_sag_final
